...
class RequestStatusRequest(BaseRequest):
    """
  Request to get current serving request status.
  """


class RequestStatus(SubscriptableBaseModel):
    request_id: Optional[str] = None
    generated_tokens: Optional[int] = None


class RequestStatusResponse(SubscriptableBaseModel):
    running_requests: Optional[Sequence[RequestStatus]] = None
    pending_requests: Optional[Sequence[str]] = None
    free_gpu: Optional[int] = None
